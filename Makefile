...
playground:
	$(CC) $(CFLAGS) -o bin/playground src/playground.c src/shaderLoader.c src/shaderCompiler.c $(GL_LIBS)


macos:
	$(CC) $(CFLAGS) -o bin/playground src/playground.c src/shaderLoader.c src/shaderCompiler.c $(OS_GL_LIBS) $(OS_X_OTHER_LIBS) $(OS_X_OTHER_FLAGS)
